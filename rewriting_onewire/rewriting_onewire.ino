...
int ow = 3;    // put the onewire bus on D0 (or 0 for a regular Arduino)
...
void setup(void) {
  Serial.begin(57600);  // local hardware test only, for Spark set to 57600, for conventional set to 9600
